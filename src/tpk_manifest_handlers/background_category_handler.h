...
#ifndef TPK_MANIFEST_HANDLERS_BACKGROUND_CATEGORY_HANDLER_H_
#define TPK_MANIFEST_HANDLERS_BACKGROUND_CATEGORY_HANDLER_H_
...
#endif  // TPK_MANIFEST_HANDLERS_BACKGROUND_CATEGORY_HANDLER_H_
