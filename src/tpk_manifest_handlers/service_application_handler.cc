...
void ParseServiceApplicationAndStore(
  ...
  std::string appid = GetParsedValue(keys::kServiceApplicationAppIDKey,
  ...
  std::string exec = GetParsedValue(keys::kServiceApplicationExecKey,
                                    keys::kServiceApplicationKeyText,
                                    control_dict);

  std::string on_boot = GetParsedValue(keys::kServiceApplicationOnBootKey,
                                       keys::kServiceApplicationKeyText,
                                       control_dict);

  std::string type = GetParsedValue(keys::kServiceApplicationTypeKey,
                                    keys::kServiceApplicationKeyText,
                                    control_dict);
...
ServiceApplicationInfo::ServiceApplicationInfo(
