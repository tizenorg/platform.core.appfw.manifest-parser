...
class ServiceApplicationInfo : public parser::ManifestData {
 public:
  ServiceApplicationInfo(
    const std::string& appid, const std::string& auto_restart,
    const std::string& exec, const std::string& on_boot,
    const std::string& type);
  ~ServiceApplicationInfo() override;
...
class ServiceApplicationHandler : public parser::ManifestHandler {
 public:
  ...
  ~ServiceApplicationHandler() override;
