...
class UIApplicationInfo : public parser::ManifestData {
 public:
  UIApplicationInfo(const std::string& appid, const std::string& exec,
                    const std::string& multiple, const std::string& nodisplay,
                    const std::string& taskmanage, const std::string& type);
